          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <?php foreach ($stores as $k => $v): ?>
                      <input class="form-control select_group" id="store" type="text" name="store[]" value="<?php echo $v['id'] ?>"><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                </div>
                
                  <!-- <input class="form-control" type="hidden" name="store[]"> -->
